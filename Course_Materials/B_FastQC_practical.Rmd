...
>    the default behaviour for fastqc.  Run the analysis again, but this time
>    try to use the `-o` option to have the report written to the QC directory.
>  
> 6. Open the html report in a browser and see if you can answer these questions:  
